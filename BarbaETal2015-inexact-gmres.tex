...
The rightmost column shows the number of iterations to converge, which is 3 or less for the 2nd-kind formulation, which explains the why we have such low speedup compared with the 1st-kind formulation.
