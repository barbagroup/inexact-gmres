...
\begin{figure}[t]
	\begin{centering}
\includegraphics[width=0.45\textwidth]{IntegrationDomain.pdf}
...
\begin{figure}%[ht]
\begin{center}
	\subfloat[][128 panels]{\includegraphics[width=0.3\textwidth]{sphere128.pdf}\label{fig:sphere128}}\qquad
	\subfloat[][2048 panels]{\includegraphics[width=0.3\textwidth]{sphere2048.pdf}\label{fig:sphere2048}}
...
\begin{figure}%[ht]
	\centering
	\includegraphics[width=0.95\textwidth]{LaplaceResidualIterations.pdf}
...
\begin{figure}%[h]
	\centering
	\includegraphics[width=0.45\textwidth]{LaplaceSpeedupRelaxation.pdf}
...
\begin{figure}%[ht]
\begin{center}
	\includegraphics[width=0.95\textwidth]{StokesSolveBreakdown.pdf}
...
\begin{figure}%[ht]
\begin{center}
	\subfloat[512 panels]{\includegraphics[width=0.3\textwidth]{RBC512.pdf}\label{fig:rbc512}}\qquad
	\subfloat[2048 panels]{\includegraphics[width=0.3\textwidth]{RBC2048.pdf}\label{fig:rbc2048}}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.75\textwidth]{4Cells_arrow.pdf}
...
\begin{figure}
\begin{center}
	\includegraphics[width=0.85\textwidth]{EthrocyteMultipleCellIterations.pdf}
...
\begin{figure}[ht]
\begin{center}
	\includegraphics[width=0.55\textwidth]{EthrocyteMultipleCellSpeedup.pdf}
