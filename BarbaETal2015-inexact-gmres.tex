...
\noindent where $x' = x\cdot r,\; y' = y\cdot r,\; \rho = \sqrt{x'^{2}+y'^{2}}$. The constants are listed in table \ref{tab:rbc_parameterization_constants}, and the transformed shapes obtained from two sphere triangulations are shown in Figure \ref{fig:glob_rbc}.
...
\bibliography{bem,CompBio,FastMethods,InexactMatVec,scicomp}
