...
It uses the technique first presented in the classic work of Hess and Smith \cite{HessSmith1967} for decomposing the integral as a sum of integrals over triangles formed by the projection of the integration point on the panel plane, and the panel vertices. Using polar coordinates, the integration over the radial component can be done analytically and that over the angular component is done by quadrature.% Also in \cite{ZhuHuangSongWhite2001}
