...
\noindent where $a$ is the size of the cluster and $r$ is the distance between the multipole center and the target. Similar bounds are available for the translation and evaluation operators \cite{greengard1987}. The following expression then applies for the number of terms needed for a given accuracy,
