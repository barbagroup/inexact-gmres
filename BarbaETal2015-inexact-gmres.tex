...
\begin{equation}
	...
	\frac{1}{2}u_i(\vect{x_0}) = -\frac{1}{8\pi\mu}\sum_{J=1}^{N}t_j\int_{\Gamma} G_{ij}(\vect{x_0}, \vect{x_J})\;\di{\Gamma_j} + \frac{1}{8\pi} \sum_{J=0}^{N}u_j\int_{\Gamma} T_{ijk}(\vect{x_0}, \vect{x_J})\cdot n_k\;\di{\Gamma_j}.
\end{equation}
...
% this figure behaves weird, and the images appear displaced upwards/ hacked it with \vspace{1cm} before each \subfloat
\begin{figure}[h]
\begin{center}
\vspace{1cm}	\subfloat[512 panels]{\includegraphics[natwidth=2.94in,natheight=1.94in,width=0.3\textwidth]{RBC512.pdf}\label{fig:rbc512}}\qquad
\vspace{1cm}	\subfloat[2048 panels]{\includegraphics[natwidth=2.94in,natheight=1.94in,width=0.3\textwidth]{RBC2048.pdf}\label{fig:rbc2048}}
...
% this figure behaves weird, and the images appear displaced upwards/ hacked it with \vspace{1.2cm} before \includegraphics
\begin{figure}[h]
\begin{center}
\vspace{1.2cm} 	\includegraphics[natwidth=6in,natheight=2.88in,width=0.75\textwidth]{4Cells_arrow.pdf}
