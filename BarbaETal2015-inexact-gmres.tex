...
\begin{center}
	...
	\caption{Residual history solving for surface traction on the surface of a sphere (first-kind integral problem), with a $10^{-5}$ solver tolerance, $8,192$ panels, and $p=16$ in the multipole expansions. Plotting script and figure available under CC-BY \cite{WangLaytonBarba2016-figshare3}.}
